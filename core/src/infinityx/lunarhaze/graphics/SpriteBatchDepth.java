...
/** {@link SpriteBatch} with added depth functionality */
public class SpriteBatchDepth implements Batch {
    ...
    /** Constructs a SpriteBatchDepth with the default shader, 2000 vertices, and 4000 triangles.
     * @see #SpriteBatchDepth(int, int, ShaderProgram) */
    public SpriteBatchDepth () {
        this(2000, null);
    }

    /** Constructs a SpriteBatchDepth with the default shader, size vertices, and size * 2 triangles.
     * @param size The max number of vertices and number of triangles in a single batch. Max of 32767.
     * @see #SpriteBatchDepth(int, int, ShaderProgram) */
    public SpriteBatchDepth (int size) {
        this(size, size * 2, null);
    }

    /** Constructs a SpriteBatchDepth with the specified shader, size vertices and size * 2 triangles.
     * @param size The max number of vertices and number of triangles in a single batch. Max of 32767.
     * @see #SpriteBatchDepth(int, int, ShaderProgram) */
    public SpriteBatchDepth (int size, ShaderProgram defaultShader) {
        this(size, size * 2, defaultShader);
    }

    /** Constructs a new SpriteBatchDepth. Sets the projection matrix to an orthographic projection with y-axis point upwards,
     ...
     * @param defaultShader The default shader to use. This is not owned by the SpriteBatchDepth and must be disposed separately.
     *           May be null to use the default shader. */
    public SpriteBatchDepth (int maxVertices, int maxTriangles, ShaderProgram defaultShader) {
    ...
    public void begin () {
        if (drawing) throw new IllegalStateException("SpriteBatchDepth.end must be called before begin.");
        renderCalls = 0;
    ...
    public void end () {
        if (!drawing) throw new IllegalStateException("SpriteBatchDepth.begin must be called before end.");
    ...
    public void draw(Texture texture, float x, float y, float originX, float originY, float width, float height, float scaleX, float scaleY, float rotation, int srcX, int srcY, int srcWidth, int srcHeight, boolean flipX, boolean flipY) {
        draw(texture, x, y, originX, originY, width, height, scaleX, scaleY, rotation, srcX, srcY, srcWidth, srcHeight, flipX, flipY, 0);
    }

    @Override
    public void draw(Texture texture, float x, float y, float width, float height, int srcX, int srcY, int srcWidth, int srcHeight, boolean flipX, boolean flipY) {
        draw(texture, x, y, width, height, srcX, srcY, srcWidth, srcHeight, flipX, flipY, 0);
    }
    ...
    public void draw(Texture texture, float x, float y, float width, float height, float u, float v, float u2, float v2) {
        draw(texture, x, y, width, height, u, v, u2, v2, 0);
    }
    ...
    public void draw(Texture texture, float[] spriteVertices, int offset, int count) {
        draw(texture, spriteVertices, offset, count, 0);
    }
    ...
    public void draw(TextureRegion region, float x, float y, float originX, float originY, float width, float height, float scaleX, float scaleY, float rotation) {
        draw(region, x, y, originX, originY, width, height, scaleX, scaleY, rotation, 0);
    }

    @Override
    public void draw(TextureRegion region, float x, float y, float originX, float originY, float width, float height, float scaleX, float scaleY, float rotation, boolean clockwise) {
        draw(region, x, y, originX, originY, width, height, scaleX, scaleY, rotation, clockwise, 0);
    }
    ...
    public void draw (Texture texture, float[] polygonVertices, int verticesOffset, int verticesCount, short[] polygonTriangles,
        ...
        if (!drawing) throw new IllegalStateException("SpriteBatchDepth.begin must be called before draw.");
    ...
    public void draw (Texture texture, float x, float y, float originX, float originY, float width, float height, float scaleX,
                      float scaleY, float rotation, int srcX, int srcY, int srcWidth, int srcHeight, boolean flipX, boolean flipY, float depth) {
        if (!drawing) throw new IllegalStateException("SpriteBatchDepth.begin must be called before draw.");
    ...
    public void draw (Texture texture, float x, float y, float width, float height, int srcX, int srcY, int srcWidth,
                      int srcHeight, boolean flipX, boolean flipY, float depth) {
        if (!drawing) throw new IllegalStateException("SpriteBatchDepth.begin must be called before draw.");
    ...
    public void draw (Texture texture, float x, float y, int srcX, int srcY, int srcWidth, int srcHeight, float depth) {
        if (!drawing) throw new IllegalStateException("SpriteBatchDepth.begin must be called before draw.");
    ...
    public void draw (Texture texture, float x, float y, float width, float height, float u, float v, float u2, float v2, float depth) {
        if (!drawing) throw new IllegalStateException("SpriteBatchDepth.begin must be called before draw.");
    ...
    public void draw (Texture texture, float x, float y, float depth) {
        draw(texture, x, y, texture.getWidth(), texture.getHeight(), depth);
    }

    
    public void draw (Texture texture, float x, float y, float width, float height, float depth) {
        if (!drawing) throw new IllegalStateException("SpriteBatchDepth.begin must be called before draw.");
    ...
    public void draw (Texture texture, float[] spriteVertices, int offset, int count, float depth) {
        if (!drawing) throw new IllegalStateException("SpriteBatchDepth.begin must be called before draw.");
    ...
    public void draw (TextureRegion region, float x, float y, float depth) {
        draw(region, x, y, region.getRegionWidth(), region.getRegionHeight(), depth);
    }

    
    public void draw (TextureRegion region, float x, float y, float width, float height, float depth) {
        if (!drawing) throw new IllegalStateException("SpriteBatchDepth.begin must be called before draw.");
    ...
    public void draw (TextureRegion region, float x, float y, float originX, float originY, float width, float height,
                      float scaleX, float scaleY, float rotation, float depth) {
        if (!drawing) throw new IllegalStateException("SpriteBatchDepth.begin must be called before draw.");
    ...
    public void draw (TextureRegion region, float x, float y, float originX, float originY, float width, float height,
                      float scaleX, float scaleY, float rotation, boolean clockwise, float depth) {
        if (!drawing) throw new IllegalStateException("SpriteBatchDepth.begin must be called before draw.");
    ...
    public void draw (TextureRegion region, float width, float height, Affine2 transform, float depth) {
        if (!drawing) throw new IllegalStateException("SpriteBatchDepth.begin must be called before draw.");
