...
//import infinityx.physics.obstacle.*;

import java.util.Iterator;

import static infinityx.lunarhaze.GameObject.ObjectType.WEREWOLF;
 ...
 */
public abstract class WorldController extends ScreenObservable implements Screen {
    ...
    private ScreenObserver listener;
    ...
    public void handleBounds(GameObject ww) {
        ...
        // Check for in bounds on bottom
        else if (ww.getY() > bounds.y + bounds.height) {
            // Set within bounds on bottom and swap velocity
            ww.setY(bounds.y + bounds.height);
            ww.setVY(0);
            System.out.println("----------------Werewolf hits bounds. NOT GOOD!");
        }
    }
...
//        }
     ...
     */
    public void setScreenListener(ScreenObserver listener) {
