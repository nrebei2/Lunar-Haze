 ...
 * deserialized into a complete {@link LevelContainer}, which can then be used to load and
 * render the level within the game.
 * <p>
...
public class LevelParser {
    ...
    private void parseAmbient(JsonValue light, RayHandler rayhandler) {
        ...
        float[] color = light.get("stealth-color").asFloatArray();
        ...
        levelContainer.setBattleAmbience(light.get("battle-color").asFloatArray());
